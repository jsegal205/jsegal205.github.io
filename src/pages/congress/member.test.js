...
describe("Member Component", () => {
  ...
  describe("when `useFetch` returns data", () => {
    ...
    describe("with 200 status", () => {
      ...
      it("displays misconduct info if present", () => {
        const chamber = "house";
        const id = "1";
        const props = {
          location: {
            ...
            misconduct: [
              {
                ...
                allegationCategories: ["corruption", "elections"],
                text: "text in [markdown](#markdown)",
              },
            ],
            status: 200,
          },
      ...
      it("displays term party if different from current party", () => {
        const chamber = "house";
        const id = "1";
        const props = {
          location: {
